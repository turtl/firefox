...
var delegate = {
	onTrack: function(window) {
		...
		if(document.getElementById('tagit_button'))
		{
			menu_btn	=	document.getElementById('tagit_button');
			menu_drop	=	document.getElementById('tagit_menupopup');
...
var install	=	function(id)
{
	...
	panel.appendChild(menu_btn);
};

var uninstall	=	function()
{
	var parent	=	menu_btn.parentNode;
	if(!parent) return;
	parent.removechild(menu_btn);
};
